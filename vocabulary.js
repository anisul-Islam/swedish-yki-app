...
export const vocabulary = JSON.parse(localStorage.getItem('vocabulary')) || [
  ...
  { word: 'Buss', meaning: 'bus', category: 'Noun' },
  { word: 'Bor', meaning: 'lives', category: 'verb' },
  ...
  { word: 'Bröd', meaning: 'Bread', category: 'Noun' },
  { word: 'Citron', meaning: 'Lemon', category: 'Noun' },
  { word: 'Välkommen', meaning: 'Welcome', category: 'Noun' },
  { word: 'Vin', meaning: 'Wine', category: 'Noun' },
  { word: 'Vatten', meaning: 'Water', category: 'Noun' },
  ...
  { word: 'kul', meaning: 'cool', category: 'Noun' },
  ...
  { word: 'ja', meaning: 'Yes', category: 'Noun' },
  ...
  { word: 'Te', meaning: 'Tea', category: 'Noun' },
  ...
  { word: 'Yng', meaning: 'Young', category: 'Noun' },
  ...
  { word: 'Öl', meaning: 'Beer', category: 'Noun' },
  ...
  { word: 'Nähä', meaning: 'oh, I don not know', category: 'Phrase' },
  ...
  { word: 'Men', meaning: 'But', category: 'Conjunction' },
];
