...
<div class="chapter-content">
        ...
        <ul>
          ...
          <li>➡️ Rule: Place “inte” after the verb:
	•	“Jag arbetar” → “Jag arbetar inte”</li>
 ...
 <h3>🚫 Negation Practice with "inte"</h3>
        ...
        <table class="phrase-table">  <thead>
        <tr><th>Original</th><th>Negated</th><th>Meaning</th></tr>
      </thead>
      <tbody>
        <tr><td>Jag arbetar här.</td><td>Jag arbetar <strong>inte</strong> här.</td><td>I work here → I don’t work here</td></tr>
        <tr><td>Jag jobbar nu.</td><td>Jag jobbar <strong>inte</strong> nu.</td><td>I work now → I’m not working now</td></tr>
        <tr><td>Renate arbetar.</td><td>Renate arbetar <strong>inte</strong>.</td><td>Renate works → Renate doesn’t work</td></tr>
        <tr><td>Olga kommer från Ryssland.</td><td>Olga kommer <strong>inte</strong> från Ryssland.</td><td>Olga comes from Russia → Olga doesn’t come from Russia</td></tr>
        <tr><td>Henrique pratar spanska.</td><td>Henrique pratar <strong>inte</strong> spanska.</td><td>Henrique speaks Spanish → He doesn’t speak Spanish</td></tr>
        <tr><td>Sofia är psykolog.</td><td>Sofia är <strong>inte</strong> psykolog.</td><td>Sofia is a psychologist → Sofia is not a psychologist</td></tr>
        <tr><td>Katerina är läkare.</td><td>Katerina är <strong>inte</strong> läkare.</td><td>Katerina is a doctor → She is not a doctor</td></tr>
      </tbody> </table> 
         <p style="margin-top: 1rem;"><em>💡 Tip: The word <strong>inte</strong> usually comes after the verb.</em></p>
  </div>
        </div>
